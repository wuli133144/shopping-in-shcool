        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
                ...
                <ul id="login" class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <img alt="avatar" style="height: 40px; width: 40px; margin-top: 5px;" src="images/avatar.png" class="img-circle dropdown-toggle avatar" data-toggle="dropdown" />
   ...
   <!--jackwu create-->
    <div class="row" style="margin:0px;">
        <div class="col-md-2 col-md-offset-2">
            <img class="logo" alt="a logo" src="images/logo/back.jpg" style="height: 50px; width:auto;" />
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-6">
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                        ...
                        <img class="first-slide" src="images/advertise/ad-1.jpg" alt="First slide">
                    ...
                    <div class="item">
                        <img class="second-slide" src="images/advertise/f1-l-ad.jpg" alt="Second slide">
                        <div class="container">
                            <div class="carousel-caption">
                                <p>
                                    <a target="_blank" class="btn btn-lg btn-primary" href="#" role="button">查看详情</a>
                    ...
                    <div class="item">
                        <img class="third-slide" src="images/advertise/ad-2.jpg" alt="Third slide">
                        <div class="container">
                            <div class="carousel-caption">
                                <p>
                                    <a target="_blank" class="btn btn-lg btn-primary" href="#" role="button">查看详情</a>
